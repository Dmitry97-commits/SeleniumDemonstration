...
public class MainPage {
    ...
    public MainPage uploadFile(){
        $(By.id("uploadPicture")).uploadFile(new File("src/test/java/resources/screenshot.png"));
        return this;
    }
    ...
    public MainPage clickBySubject(){
        actions().moveToElement($x("//div[contains(@class,'subjects-auto-complete__v')]")).click().sendKeys(Keys.ENTER).perform();
        return this;
    }
